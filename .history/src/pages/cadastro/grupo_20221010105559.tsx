...
interface DataForm{
    ...
    cidadePertencente2 : String
    planoPertencente2: String
    isDisable : boolean
    isDisable2 : boolean
}
...
export default function CadastrarCidade({grupo,cidade, plano}){
    ...
    isDisable2: true, planoPertencente2 : null, cidadePertencente2 : null});
                        ...
                        <div className="filtros">
                                ...
                                <FormControl sx={{m : 0, minWidth: 220}}>
                                    ...
                                    >
                                        {
                                            plano.map(function(plano){
                                                if(form.cidadeSelecionada == plano.cidade.idkey){
                                                    return(
                                                        <MenuItem value={plano.idkey}>{plano.descricao}</MenuItem>
                                                    )
                                                }

...
export default function CadastrarCidade({grupo,cidade, plano}){
    ...
    async function desabilitarCampo(){
        if(form.cidadePertencente == '0'){
            ...
            <div>
                        ...
                        <div className="filtros">
                                ...
                                <FormControl sx={{m : 0, minWidth: 220}}>
                                    ...
                                    >
                                        {
                                            plano.map(function(plano){
                                                if(form.cidadeSelecionada == plano.idkey_cidade && form.planoPertencente == grupo.idkey_plano){
                                                    return(
                                                        <MenuItem value={plano.idkey}>{plano.descricao}</MenuItem>
                                                    )
                                                }
                    ...
                    {    
                        grupo.map(function(grupo){
                            if(form.cidadeSelecionada == grupo.plano.cidade.idkey)
                            {
                                return(

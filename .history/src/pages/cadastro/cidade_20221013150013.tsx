...
export default function CadastrarCidade({cidade}) {
    ...
    async function enviarFoto(data: DataForm){
        try{
            const formData = new FormData();
            formData.append("image", imagem);
      
            fetch('http://localhost:3000/api/uploads/images/index',{
            ...
            .then(() =>{
                setForm({imagem : null, nomeCidade : '', urlBrasao : ''})
            })
        }catch(error){
            console.log(error);
        }
                                                ...
                                                <div className="divInput">
                                                    <div className='inputImage'>
                                                        <h3> Escolha um brasão para esta cidade:</h3>     
                                                            <input className="enviar" id="fileSelect" type='file' accept=".jpeg, .jpg, .png"/>
                                                    </div>

...
export default function CadastrarCidade({cidade}) {
    ...
    const uploadParaServer = async (event) =>{
        const body = new FormData();
        body.append("file", imagem);
        const response = await fetch('http://localhost:3000/api/uploads/images/index',{
            method : 'POST',
            body
        });
    };
            ...
            <NavBar></NavBar>
                ...
                <div>
                    <div className='f1'>
                        ...
                        />
                        <Button id='botao' size='large' variant="contained" type='submit' onClick={uploadParaServer}>
                            Enviar imagem
                        </Button>    
                        Enviar Imagem
                    </div>

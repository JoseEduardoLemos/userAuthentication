...
export default function CadastrarPlano({plano,cidade, grupo}){
                            ...
                            <form onSubmit= {e =>{ 
                                ...
                                <div className='cardCidade'>
                                    <div className='cardSeparador'>
                                        ...
                                        <div className='f12'>
                                                <Button id='botaolimpar' size="large" type='reset' variant="outlined"
                                                onClick={() =>{
                                                    clearForms(form)
                                                }}>LImpar</Button>
                    ...
                    
                    {
                        plano.map(function(plano){
                            if(form.cidadeSelecionada == plano.idkey_cidade){
                                return(
                                    <CardListagemPlano id={plano.idkey} descricao={`${plano.descricao}`} cidade={plano.cidade} plano={plano} grupo={plano.grupo}/>
                                )
                            }
                        })
                    }

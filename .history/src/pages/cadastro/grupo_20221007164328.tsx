            ...
            <div>
                                    ...
                                    <MenuItem value={0}>{`Nenhum`}</MenuItem>
                                        {
                                            plano.map(plano =>{
                                                return(
                                                    <MenuItem value={plano.idkey}>{plano.nome}</MenuItem>
                                                )
                                            })
                                        }   
                    ...
                    <div className='cardCidade'>
                    {
                        grupo.map(function(grupo){
                            if(form.cidadeSelecionada == grupo.plano.cidade.idkey && form.planoSelecionado == grupo.plano.idkey)
                            {
                                <CardListagemGrupo id={grupo.idkey} descricao={`ID: ${grupo.idkey}) ${grupo.descricao} ${grupo.plano.cidade.nome}`}/>
                            }
                            else{
                                return(
                                    <CardListagemGrupo id={grupo.idkey} descricao={`ID: ${grupo.idkey}) ${grupo.descricao}`}/>
                                )
                            }
                        })
                    }

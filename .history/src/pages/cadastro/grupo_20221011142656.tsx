        ...
        try{
            ...
            .then(() => {
                ...
                setForm(
                    ...
                    isDisable:true, isDisable2: true, cidadeSelecionada : form.cidadeSelecionada, planoSelecionado : form.planoSelecionado}
                )
            router.replace(router.asPath)
            })
        }catch(error){
            ...
            <div>
                    ...
                    {    
                        grupo.map(function(grupo){
                            ...
                            {
                                return(
                                    <CardListagemGrupo id={grupo.idkey} descricao={`${grupo.descricao}`}
                                    cidade={cidade} plano={plano} grupo={grupo}/>
                                )
                            }
                        })
                    }

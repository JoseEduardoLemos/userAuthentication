...
export default function CadastrarCidade({grupo, plano, cidade}){
    ...
    const [form, setForm] = useState<DataForm>({descricaoGrupo: '', planoPertencente: '', cidadePertencente:''});
    ...
    async function submitForm(data : DataForm){
        ...
        try{
            ...
            .then(() => {
                setForm(
                    {descricaoGrupo : '', planoPertencente: '', cidadePertencente: ''}
                )
            router.replace(router.asPath)
            })
        }catch(error){
    ...
    async function clearForms(data : DataForm){
        setForm({descricaoGrupo : '', planoPertencente: '', cidadePertencente: ''})
    }

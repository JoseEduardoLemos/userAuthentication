                                                ...
                                                <FormControl sx={{m : 0, minWidth: 220}}>
                                                    <InputLabel id="demo-simple-select-autowidth-label">Cidade Pertencente *</InputLabel>
                                                        <Select
                                                            ...
                                                            onChange={e=> setForm({...form, cidadePertencente : e.target.value, isDisabled2 : false})}
                                                            autoWidth
                                            ...
                                            <FormControl sx={{m : 0, minWidth: 220}}>
                                                <InputLabel id="demo-simple-select-autowidth-label">Grupo pertencente *</InputLabel>
                                                    <Select
                                                        ...
                                                        onChange={e=> setForm({...form, grupoPertencente : e.target.value, isDisabled : false})}
                                                        autoWidth
                                                ...
                                                {                                               
                                                    grupo.map(grupo =>{
                                                        return(
                                                        <MenuItem value={grupo.idkey}>{`${grupo.plano} / ${grupo.plano.descricao} / ${grupo.descricao}`}</MenuItem>
                                                    )})                                                
                                                }    
                                                </Select>
                                            </FormControl>

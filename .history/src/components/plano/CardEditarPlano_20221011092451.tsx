...
export default function CardListagemGrupo({plano, cidade}){
    const [form, setForm] = useState<DataForm>({idkeyCidade: plano.cidade_idkey, idkey : plano.idkey, descricao : plano.descricao, cidadePertencente : plano.cidade.nome})
    const [openEdicao, setOpenEdicao] = useState(true);
    console.log(plano.cidade.idkey)
    ...
    async function clearForms(data : DataForm){
        setForm({idkeyCidade : plano.cidade_idkey, idkey : plano.idkey, descricao : plano.descricao, cidadePertencente : plano.cidade.nome})
    }

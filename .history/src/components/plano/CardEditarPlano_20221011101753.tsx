...
export default function CardListagemGrupo({plano, cidade}){
    const [form, setForm] = useState<DataForm>({ idkey : plano.idkey, descricao : plano.descricao, cidadePertencente : plano.idkey_cidade})
    ...
    async function clearForms(data : DataForm){
        setForm({idkey : plano.idkey, descricao : plano.descricao, cidadePertencente : plano.idkey_cidade})
    }

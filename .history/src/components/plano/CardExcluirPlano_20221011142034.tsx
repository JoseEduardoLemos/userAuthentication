...
export default function CardExcluirPlano({plano}){
    ...
    async function deletarGrupo (){
        try{
            fetch(`http://localhost:3000/api/planos/delete/${plano.idkey}`,{   
                headers : {
        ...
        <>
            ...
            <div>
                ...
                >
                    ...
                    {`Deseja excluir permanentemente o plano "${plano.descricao}"?`}
                    </DialogTitle>
                    <DialogContent>

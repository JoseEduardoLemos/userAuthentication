...
export default function CardListagemGrupo({cidade, plano, grupo}){
    ...
    const [form, setForm] = useState<DataForm>({cidadePertencente : grupo.plano.idkey_cidade, planoPertencente: null, descricaoGrupo : '', isDisable : true})
                                    ...
                                    <div>
                                        <div className='f1'>
                                            <TextField
                                                ...
                                                fullWidth
                                                label={`Descrição atual: ${grupo.descricao}`}
                                                variant="outlined"

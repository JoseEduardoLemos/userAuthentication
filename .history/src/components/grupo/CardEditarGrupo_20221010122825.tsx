import { Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, FormControl, InputLabel, Select, TextField } from "@mui/material";
...
export default function CardListagemGrupo({id, descricao}, {cidade, plano}){
    ...
    const [form, setForm] = useState<DataForm>({cidadePertencente : null, planoPertencente: null, descricaoGrupo : ''})

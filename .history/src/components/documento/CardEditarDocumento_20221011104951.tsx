...
export default function CardListagemGrupo({cidade, plano, grupo, link}){
    ...
    const [form, setForm] = useState<DataForm>({idkey: link.idkey, cidadePertencente : link.grupo.plano.idkey_cidade, planoPertencente: link.grupo.idkey_plano, descricao : link.descricao})

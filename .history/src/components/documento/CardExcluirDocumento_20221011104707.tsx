...
export default function CardExcluirDocumento({cidade, plano, grupo, link}){

    const [form, setForm] = useState<DataForm>({idkey: grupo.idkey, cidadePertencente : grupo.plano.idkey_cidade, planoPertencente: grupo.idkey_plano, descricaoGrupo : grupo.descricao, isDisable : true})

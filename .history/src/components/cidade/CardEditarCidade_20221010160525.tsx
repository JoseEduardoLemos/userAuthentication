...
export default function CardListagemGrupo({cidade, plano, grupo}){
    ...
    const [form, setForm] = useState<DataForm>({idkey : null ,nomeCidade : cidade.nome, urlBrasao : cidade.urlBrasao})
    ...
    async function clearForms(data : DataForm){
        setForm({nomeCidade : cidade.nomeCidade, urlBrasao : cidade.urlBrasao})
    }
